...
export const TimelineItem: React.FC<TimelineItemProps> = ({
  ...
  return (
    <div className="flex flex-row-reverse relative h-[360px] md:w-full">
      <span className="text-[42px] font-bold mt-4 md:hidden">
        {displayNumber < 10 ? `0${displayNumber}` : displayNumber}
      </span>
      <div className="bg-teal-900 h-[300px] w-[2px] absolute right-[16px] top-[80px] md:hidden" />
      ...
      {showLoadingBelow && (
        <span className="text-lg absolute right-0 -bottom-14 md:hidden">
          <TypeAnimation
